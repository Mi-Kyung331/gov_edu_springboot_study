...
public class UsersController {
    ...
    public ResponseEntity<?> modifyFullPassword(@PathVariable Integer userId, @RequestBody UserPasswordModifyDto dto, @AuthenticationPrincipal PrincipalUser principalUser) {
        // PrincipalUser principalUser = (PrincipalUser) SecurityContextHolder.getContext().getAuthentication().getPrincipal();
        // @AuthenticationPrincipal이 가지고 오기 때문에 상단의 코드는 쓰지 않아도 된다.
        System.out.println(userId);
        System.out.println(dto);
